...
<div className="card m-6 shadow-lg flex justify-center">
  <div className=" shadow-lg bg-white max-w-sm">
      <img  src="../photo.png" alt="first"/>
    <div className="p-6">
...
<div className="card1 m-6 shadow-lg flex justify-center">
  <div className=" shadow-lg bg-white max-w-sm">
      <img  src="../photo-1.png" alt="second"/>
    <div className="p-6">
      <p className="text-gray-700 text-base mb-4">
